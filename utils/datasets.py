...
from utils.general import LOGGER, NUM_THREADS, check_requirements, xyxy2xywh, xywh2xyxy, xywhn2xyxy, xyn2xy, segment2box, segments2boxes, \
...
class LoadImagesAndLabels(Dataset):
    ...
    def cache_labels(self, path=Path('./labels.cache'), prefix=''):
        ...
        with Pool(NUM_THREADS) as pool:
            # verify_image_label(self.img_files, self.label_files, prefix, self.cls_names)
